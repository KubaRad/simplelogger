...
from simplelogger import LoggerToDbError, cli
from simplelogger.cli import LoggerToDb
...
class ConfigurationWithUnsupportedFormatTestCase(TestCase):
    @patch("simplelogger.cli.Enhydris")
...
class CorrectConfigurationTestCase(TestCase):
    @patch("simplelogger.cli.Enhydris")
    @patch("simplelogger.meteologgerstorage.MeteologgerStorage_simple")
...
class UploadErrorTestCase(TestCase):
    ...
    @patch("simplelogger.cli.logging")
    @patch("simplelogger.cli.sys.stderr.write")
    @patch("simplelogger.cli.Enhydris")
