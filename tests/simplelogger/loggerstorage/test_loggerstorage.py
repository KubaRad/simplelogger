...
from simplelogger import ConfigurationError
from simplelogger.meteologgerstorage import MeteologgerStorage
...
class MeteologgerStorageFixDstTestCase(TestCase):
    ...
    @patch(
        "simplelogger.meteologgerstorage.dt.datetime.now",
        return_value=dt.datetime(2018, 10, 28, 2, 0, tzinfo=dt.timezone.utc),
    )
    @patch("simplelogger.meteologgerstorage.dt.datetime", new=PatchableDatetime)
