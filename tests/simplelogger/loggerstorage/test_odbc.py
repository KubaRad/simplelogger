...
from simplelogger.exceptions import ConfigurationError
from simplelogger.meteologgerstorage import MeteologgerStorage_odbc
...
class GetStorageTailTestCase(TestCase):
    @patch("simplelogger.meteologgerstorage.pyodbc")
    @patch(
        "simplelogger.meteologgerstorage.MeteologgerStorage"
