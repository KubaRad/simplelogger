...
from simplelogger.exceptions import ConfigurationError, MeteologgerStorageReadError
from simplelogger.meteologgerstorage import MeteologgerStorage_pc208w
...
class CheckParametersTestCase(TestCase):
    def test_raises_error_on_subset_identifiers_missing(self):
        ...
        with self.assertRaisesRegex(ConfigurationError, expected_error_message):
            ...
            MeteologgerStorage_pc208w(cfg["mystation"])
